...
//create schema
module.exports = {
    games : 'CREATE TABLE IF NOT EXISTS `Games` (`id` INTEGER NOT NULL AUTO_INCREMENT, `sport` VARCHAR(50) NULL DEFAULT NULL, `rules` VARCHAR(500) NULL DEFAULT NULL, `time` VARCHAR(10) NULL DEFAULT NULL, `location` VARCHAR(500) NULL DEFAULT NULL, `originalPlayers` INTEGER NULL DEFAULT 1, `joinedPlayers` VARCHAR(1000) NULL DEFAULT NULL, `playersNeeded` INTEGER NULL DEFAULT NULL, `created_by` VARCHAR(50) NULL DEFAULT NULL, `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP, `locations_id` INTEGER NULL DEFAULT NULL, PRIMARY KEY (`id`) );',
