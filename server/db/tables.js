...
//create schema
module.exports = {
    games : 'CREATE TABLE IF NOT EXISTS `Games` (`id` INTEGER NOT NULL AUTO_INCREMENT, `sport` VARCHAR(50) NULL DEFAULT NULL, `rules` VARCHAR(500) NULL DEFAULT NULL, `time` VARCHAR(10) NULL DEFAULT NULL, `location` VARCHAR(150) NULL DEFAULT NULL, `currentPlayers` INTEGER NULL DEFAULT 1, `maxPlayers` INTEGER NULL DEFAULT NULL, `created_by` VARCHAR(50) NULL DEFAULT NULL, `created_at` TIMESTAMP NULL DEFAULT NULL, `location_id` INTEGER NULL DEFAULT NULL, PRIMARY KEY (`id`) );',
